...
async def list_materials(request: Request, type: Optional[str] = None, search: Optional[str] = None, low_stock: Optional[str] = None):
    ...
    if low_stock and low_stock.lower() == "true":
        ...
        for s in stock_docs:
            ...
            if mid:
                stock_by_mat[mid] = stock_by_mat.get(mid, 0) + float(s.get("quantity") or 0)
