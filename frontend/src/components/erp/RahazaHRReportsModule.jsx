  ...
  return (
    <div className="space-y-5" data-testid="hr-reports-page">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Laporan HR & Analytics</h1>
          ...
          <GlassCard className="p-6">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={[
                    { name: 'Gross Salary', value: payrollData.chart_data.gross_salary },
                    { name: 'Deductions', value: payrollData.chart_data.deductions },
                  ]}
                  cx="50%"
                  cy="50%"
                  labelLine={false}
              ...
              <table className="w-full text-sm">
                <thead className="border-b border-[var(--glass-border)]">
                  <tr className="text-left text-muted-foreground">
                    ...
                    <th className="pb-3 font-semibold text-right">Deductions</th>
